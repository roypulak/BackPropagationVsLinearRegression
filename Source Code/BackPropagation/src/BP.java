...
public class BP {
	...
	private static final int TRAINING_REPS = 10000000;//10000000;//number of epoch
	...
	private static final int MAX_SAMPLES = 401;
	private static final int TEST_SAMPLES = 401;
	private static final int TOTAL_PATTERN = 451;
	...
	private static void inputDataProcess() {
		...
		try {
			br = new BufferedReader(new FileReader("E:/Algorithm Codes/BackPropagation/inputFiles/trainingData.txt"));
	...
	private static void testNetwork() {	
		...
		try {
			...
			File file = new File("E:/Algorithm Codes/BackPropagation/outputFiles/bpout.txt");
